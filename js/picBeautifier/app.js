const objFunctions = {
  ...
  cardifyStyles: (element, img, color, text) => {
    ...
    let paragraph = `<a href='${text}.html'><figcaption style='font-size: 45px;font-weight:900;text-transform: none;text-align:center; color:white; display:block; padding: 0 15px; position:absolute; top:40%; width:100%;'>${text}</figcaption></a>`;
